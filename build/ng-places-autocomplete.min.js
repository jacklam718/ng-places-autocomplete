!function(){"restrict";function e(e){var t=[];for(var o in e)t.push(o+"="+e[o]);return t.join("&")}function t(t){if(void 0===this.staticMapApiUrl)throw"without static map apt url";var o={zoom:16,maptype:"roadmap"};return this.staticMapApiUrl+"?"+e(angular.extend({},o,t))}function o(){var e=this;return e.staticMapApiUrl="https://maps.googleapis.com/maps/api/staticmap",e.init=function(t,o,a,n){e.elem=t,e.onSearchComplete=n,e.autocomplete=new google.maps.places.Autocomplete(t[0],{language:a,componentRestrictions:{country:o}}),e.placesService=new google.maps.places.PlacesService(t[0]),e.initAutocomplete()},e.initAutocomplete=function(){google.maps.event.addListener(e.autocomplete,"place_changed",function(){var t=e.autocomplete.getPlace();e.placesService.getDetails({reference:t.reference},function(t){e.onSearchComplete(e.placeBuilder(t))})})},e.placeBuilder=function(t){var o={};return o.formatted_address=e.elem.val(),o.location={lat:t.geometry.location.lat(),lng:t.geometry.location.lng()},o},e.getStaticMapQueryUrl=function(e){var o={size:"400x400"};return t.call(this,angular.extend({},o,e))},e}function a(){var e=this;return e.staticMapApiUrl="http://api.map.baidu.com/staticimage",e.init=function(t,o,a){e.elem=t,e.city=o,e.onSearchComplete=a,e.autocomplete=new BMap.Autocomplete({input:t[0],location:o}),e.initAutocomplete()},e.initAutocomplete=function(){e.autocomplete.addEventListener("onconfirm",function(t){var o=e.elem.val(),a=new BMap.LocalSearch(o,{onSearchComplete:function(o){e.onSearchComplete(e.placeBuilder(o,t))}});a.search(o)})},e.placeBuilder=function(e,t){var o={};return o.formatted_address=[t.item.value.city,t.item.value.district].join(),o.location={lat:e.getPoi(0).point.lat,lng:e.getPoi(0).point.lng},o},e.getStaticMapQueryUrl=function(e){var o=[e.center.split(",")[1],e.center.split(",")[0]].join(","),a={width:400,height:400};return e.center=o,t.call(this,angular.extend({},a,e))},e}function n(e,t){var o={},a={google:e,baidu:t};return o.scope={city:"=?",country:"=?",lang:"=?",service:"=?",mapPopup:"=?",mapPopupConfig:"=?",ngModel:"="},o.onSearchComplete=function(e){o.$scope.$apply(function(){o.scope.ngModel=e,o.$scope.$emit("places-autocomplete:select",e)})},o.getStaticMap=function(e,t){if("object"==typeof o.scope.ngModel&&o.scope.ngModel.location.lat&&o.scope.ngModel.location.lng){var a=o.scope.ngModel.location.lat,n=o.scope.ngModel.location.lng,i=[a,n].join(","),c=o.provider.getStaticMapQueryUrl({center:i}),l=angular.element("<img>");l.attr({src:c}),e.tooltipster("content",l)}t()},o.controller=["$scope",function(e){o.$scope=e;var t={};t.city="beijing",t.country="us",t.service="google",t.lang="en",["city","country","service","lang"].forEach(function(o){(void 0===e[o]||""===e[o])&&(e[o]=t[o])})}],o.link=function(e,t,n){if(o.provider=a[e.service],e.mapPopup||void 0!==t.attr("map-popup")){var i=$(t),c={animation:"grow",delay:200,theme:"tooltipster-light",touchDevices:!1,trigger:"hover",functionBefore:o.getStaticMap};i.addClass("tooltip fancy-tooltip"),i.tooltipster(angular.extend({},c,e.mapPopupConfig))}e.$watch("city",function(a,n){switch(e.service){case"google":o.provider.init(t,e.country,e.lang,o.onSearchComplete);break;case"baidu":o.provider.init(t,e.city,o.onSearchComplete)}})},o}n.$inject=["GoogleMapService","BaiduMapService"],angular.module("ng-places-autocomplete",[]),angular.module("ng-places-autocomplete").directive("placesAutocomplete",n),angular.module("ng-places-autocomplete").factory("GoogleMapService",o),angular.module("ng-places-autocomplete").factory("BaiduMapService",a)}();
